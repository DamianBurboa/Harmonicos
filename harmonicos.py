...
senalRectangunlar = SquareSignal(freq=2, amp=1.0, offset=numpy.pi)
waveRectangular = senalRectangunlar.make_wave(duration=1, start=0, framerate=44100)
...
mezcla = senalSenoidal + harmonico1 + harmonico2 + harmonico3 + harmonico5 + harmonico6
